...
@section('title')
{{ trans('Location::ward.add.header_title') }}
@endsection
    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5"><a href="{{ route('Ward') }}" class="text-dark text-hover-success"><i class="icon-1x text-dark-10 flaticon2-fast-back"></i></a> {{ trans('Location::ward.add.header_title') }}</h5>
                <!--end::Title-->
            </div>
            <!--end::Details-->
            <!--begin::Toolbar-->
            <div class="d-flex align-items-center">
                <!--begin::Button-->
                <a href="{{ route('Ward') }}" class="btn btn-default text-dark text-hover-success font-weight-bold btn-sm px-3  text-hover-success font-size-base"><i class="icon-1x text-dark-50 flaticon2-back-1"></i> {{ trans('Location::ward.add.header_btn_back') }}</a>
                <!--end::Button-->
                <!--begin::Dropdown-->
