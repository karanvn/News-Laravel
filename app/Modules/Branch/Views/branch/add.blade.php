...
@section('title')
{{ trans('Branch::branch.add.header_title') }}
@endsection
    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5"><a href="{{ route('Branch') }}" class="text-dark text-hover-success"><i class="icon-1x text-dark-10 flaticon2-fast-back"></i></a> {{ trans('Branch::branch.add.header_title') }}</h5>
                <!--end::Title-->
            </div>
            <!--end::Details-->
            <!--begin::Toolbar-->
            <div class="d-flex align-items-center">
                <!--begin::Button-->
                <a href="{{ route('Branch') }}" class="btn btn-default text-hover-success font-weight-bold btn-sm px-3 font-size-base">{{ trans('Branch::branch.add.header_btn_back') }}</a>
                <!--end::Button-->
                <!--begin::Dropdown-->
