...
<div class="container">
    <div class="col-12 pb-3 pt-5 rounded">
        <form method="post" class="form-horizontal" role="form" action="{{route('static-page-edit-post')}}" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="d-flex align-items-baseline flex-wrap mr-5">
                            ...
                            <h5 class="text-dark font-weight-bold my-1 mr-5 text-uppercase"><a
                                    href="{{route('static-page')}}" class="text-dark text-hover-success"><i
                                        class="icon-1x text-dark-10 flaticon2-fast-back"></i></a>Sửa Page Tĩnh
                            </h5>
                            <!--end::Page Title-->
                            <!--begin::Breadcrumb-->
