...
@section('title')
{{ trans('Blog::blog.edit.header_title') }}
@endsection
{{-- <script src="//cdn.ckeditor.com/4.15.1/full/ckeditor.js"></script> --}}
<script src="{{asset('js/crud/ckeditor/ckeditor.js')}}"></script>
@section('content')
<div class="container">
    <div class="col-12 pb-3 pt-5 rounded">
        <form method="post" class="form-horizontal" role="form" action="{{route('blog-edit-post')}}" enctype="multipart/form-data">
            @csrf
                ...
                <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                        ...
                        <div class="d-flex align-items-baseline flex-wrap mr-5">
                            ...
                            <h5 class="text-dark font-weight-bold my-1 mr-5 text-uppercase"><a
                                    href="{{ route('blog-list') }}" class="text-dark text-hover-success"><i
                                        class="icon-1x text-dark-10 flaticon2-fast-back"></i></a>{{ trans('Blog::blog.edit.header_title') }}
                            </h5>
                            <!--end::Page Title-->
                            <!--begin::Breadcrumb-->
                            <!--end::Breadcrumb-->
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="btn-group ml-2">
                            <a href="{{ route('blog-delete',$blog->id) }}" class="btn btn-warning font-weight-bold btn-sm px-3 font-size-base"><i
                                    class="icon-x fas fa-save"></i>
                                {{ trans('Blog::blog.add.header_btn_delete') }}
                            </a>
                        </div>
                        <!--end::Dropdown-->
                        <!--begin::Dropdown-->
                        <div class="btn-group ml-2">
                            <button type="submit" class="btn btn-success font-weight-bold btn-sm px-3 font-size-base"><i
                                    class="icon-x fas fa-save"></i>
                                {{ trans('Blog::blog.add.header_btn_save') }}
                            </button>
                        </div>
                        <!--end::Dropdown-->
                    </div>
                                                    ...
                                                    <div class="card-body pt-5">
                                                        {{-- <div class="col-lg-12">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <input type="name" class="form-control" name="title_short" value="{{ $blog->title_short }}">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <input type="name" class="form-control" name="slug" value="{{ $blog->slug }}">
                                                                @if($errors->has('slug'))
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <textarea id="blog_description"  class="ckeditor" name="description" rows="3">{{ $blog->description }}</textarea>
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-form-label" style="width: 100%">Nội dung bài viết 
                                                                    <span class="label-text-error">*</span></label>
                                                                    <textarea id="blog_content"  class="ckeditor" name="content" rows="3">{{ $blog->content }}</textarea>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <select class="form-control custom-select" name="status">
                                                                    <option disabled >---Chọn Danh Mục---</option>
                                                                    <option value="D" {{ $blog->status=='D' ? 'selected' : '' }}>Ẩn</option>
                                                                    <option value="A" {{ $blog->status=='A' ? 'selected' : '' }}>Kích hoạt</option>
                                                                </select>
