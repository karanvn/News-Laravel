        ...
        <div class="card-body pt-4">
            ...
            <div class="py-9">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <span class="text-muted">{{ $partner->address }}</span>
                </div>
                <div class="d-flex align-items-center justify-content-between mb-2">
                    <span class="font-weight-bold mr-2">Created At:</span>
                    <a href="#" class="text-muted text-hover-primary">{{ $partner->created_at }}</a>
                </div>
                <div class="d-flex align-items-center justify-content-between mb-2">
                    <span class="font-weight-bold mr-2">Created By:</span>
                    <a href="#" class="text-muted text-hover-primary">{{ $partner->user->name }}</a>
                </div>
            </div>
            <!--end::Contact-->
            <!--begin::Nav-->
            <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                <div class="navi-item mb-2">
                    <a href="{{ route('PartnerEdit', [$partner->id, 'overview' ]) }}" class="navi-link py-4 {{ $page == 'overview' ? 'active' : '' }}">
                        ...
                        <span class="navi-text font-size-lg">{{ trans('Partner::partner.edit.header_overview') }}</span>
                    </a>
                </div>
                <div class="navi-item mb-2">
                    <a href="{{ route('PartnerEdit', [$partner->id, 'personal' ]) }}" class="navi-link py-4 {{ $page == 'personal' ? 'active' : '' }}">
                        ...
                        <span class="navi-text font-size-lg">{{ trans('Partner::partner.edit.header_personal') }}</span>
                    </a>
                </div>
                ...
                <div class="navi-item mb-2">
                    <a href="{{ route('PartnerEdit', [$partner->id, 'payment' ]) }}" class="navi-link py-4 {{ $page == 'payment' ? 'active' : '' }}">
                        ...
                        <span class="navi-text font-size-lg">{{ trans('Partner::partner.edit.header_payment') }}</span>
                    </a>
                </div>
                ...
                <div class="navi-item mb-2">
                    <a href="{{ route('PartnerEdit', [$partner->id, 'invoice' ]) }}" class="navi-link py-4 {{ $page == 'invoice' ? 'active' : '' }}">
                        ...
                        <span class="navi-text font-size-lg">{{ trans('Partner::partner.edit.header_invoice') }}</span>
                    </a>
                </div>
                ...
                <div class="navi-item mb-2">
                    <a href="{{ route('PartnerEdit', [$partner->id, 'picking' ]) }}" class="navi-link py-4 {{ $page == 'picking' ? 'active' : '' }}">
                        <span class="navi-icon mr-2">
                            <span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Home\Building.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                        ...
                        <span class="navi-text font-size-lg">{{ trans('Partner::partner.edit.header_picking_address') }}</span>
                    </a>
                </div>
                ...
                <div class="navi-item mb-2">
                    <a href="{{ route('PartnerEdit', [$partner->id, 'user' ]) }}" class="navi-link py-4 {{ $page == 'user' ? 'active' : '' }}">
                        ...
                        <span class="navi-text font-size-lg">{{ trans('Partner::partner.edit.header_user') }}</span>
                    </a>
                </div>
