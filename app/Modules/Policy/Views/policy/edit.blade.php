...
@section('title')
{{ trans('Policy::policy.edit.header_title') }}
@endsection
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5 text-uppercase"><a href="{{ route('Policy') }}" class="text-dark text-hover-success"><i class="icon-1x text-dark-10 flaticon2-fast-back"></i></a> {{ trans('Policy::policy.edit.header_title') }}</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
            ...
            <div class="d-flex align-items-center">
                <!--begin::Button-->
                <a href="{{ route('Policy') }}" class="btn btn-default font-weight-bold btn-sm px-3 font-size-base">{{ trans('Policy::policy.add.header_btn_back') }}</a>
                <!--end::Button-->
                <!--begin::Dropdown-->
