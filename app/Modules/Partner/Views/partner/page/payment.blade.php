    ...
    <div class="card card-custom card-stretch">
        ...
        <div class="card-header py-3">
            <div class="card-title align-items-start flex-column">
                <h3 class="card-label font-weight-bolder text-dark">{{ trans('Partner::partner.edit.header_payment') }}</h3>
                <span class="text-muted font-weight-bold font-size-sm mt-1">{{ trans('Partner::partner.edit.sub_payment') }}</span>
            </div>
        ...
        <!--end::Header-->
        <!--begin::Form-->
            @include('Partner::partner.form.payment_item')
        <!--end::Form-->
    </div>
    </form>
