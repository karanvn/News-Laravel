...
<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-2">
            <!--begin::Title-->
            <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5"><i class="icon-x text-dark-10 flaticon-users-1"></i><a href="{{ route('Admin') }}" class="text-dark text-hover-success"> {{ trans('Auth::admin.list.header_title') }}</a></h5>
            <!--end::Title-->
            <!--begin::Separator-->
        ...
        <div class="d-flex align-items-center">
            ...
            <a href="{{ route('AdminAdd') }}" class="btn btn-light-success font-weight-bold ml-2"><i class="icon-x text-dark-10 flaticon2-plus-1"></i>{{ trans('Auth::admin.list.header_add_btn') }}</a>
            @endif
            <!--end::Button-->
            <!--begin::Dropdown-->
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                        ...
                        <div class="card card-custom gutter-b card-stretch">
                            ...
                            <div class="card-body p-4">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-shrink-0 mr-4 mt-lg-0 mt-3">
                                            <div class="symbol symbol-circle symbol-lg-75">
                                                ...
                                                <img src="{{  show_image(config('auth_.image.thumb_path'), $user->avatar) }}" alt="image">
                                                @else
                                        ...
                                        <div class="d-flex flex-column">
                                            <a href="{{ route('AdminEdit', [$user->id, 'general']) }}" class="text-dark font-weight-bolder text-hover-primary font-size-h4 mb-0"><span class="text-{{ $user->status == 'A' ? 'success' : 'danger' }}">{{ $user->name }}</span></a>
                                ...
                                <!--end::User-->
                                <!--begin::Desc-->
                                {{-- <p class="mb-7">!empty($user->partner)?$user->partner->name:'' </p>--}}
                                <!--end::Desc-->
                                <!--begin::Info-->
                                <!--end::Info-->
