...
<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-2">
            <!--begin::Title-->
            <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5"><i class="icon-x text-dark-10 flaticon-users-1"></i><a href="{{ route('Admin') }}" class="text-dark text-hover-success"> DANH SÁCH MAIL CHÚC SINH NHẬT</a></h5>
            <!--end::Title-->
            <!--begin::Separator-->
                    ...
                    <div class="card card-custom card-stretchs gutter-b">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center flex-wrap">
                                {!! @$mails->links('Product::product.paginate', ['paginator' => @$mails, 'filter' => @$filter]) !!}
                            </div>
                            <!--end:: Pagination-->
                        </div>
                        @endif
                                    ...
                                    <div class="d-flex align-items-end">
                                        <div class="d-flex align-items-center">
                                            <div class="d-flex flex-column">
                                                ...
                                                <span style="width: 70px" class="label label-{{ @$item->status == '1' ? 'success' : 'danger' }} label-inline mr-2">{{ get_combo_statuses()[@$item->status] }}</span>
                                                <span class="text-muted font-weight-bold">{{ @$item->email }}
                                                </span>
