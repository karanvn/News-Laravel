<div class="col-lg-12" id="box_orders">
    <!--begin::List Widget 10-->
    <div class="card card-custom card-stretchs gutter-b">
        <!--begin::Header-->
        <div class="card-header border-0">
            <h3 class="card-title font-weight-bolder text-dark">{{ trans('Api::api.user.orders.header') }}</h3>
            <div class="card-toolbar">
                <div class="accordion accordion-light accordion-light-borderless accordion-toggle-plus" id="accordion_orders">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title collapse text-hover-primary" data-toggle="collapse" data-target="#collapse_orders" aria-expanded="false">
        ...
        <div class="card-bodys pt-5">
            <div class="col-lg-12 collapse show" id="collapse_orders" data-parent="#accordion_orders">
                <div class="p-4">
                    ...
                    <div class="d-flex align-items-center justify-content-between font-size-h6">
                        <div class="col-lg-12 json_success_orders">
                    ...
                    <div class="d-flex align-items-center justify-content-between font-size-h6">
                        <div class="col-lg-12 json_error_orders">
