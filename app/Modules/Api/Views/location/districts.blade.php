<div class="col-lg-12" id="box_districts">
    <!--begin::List Widget 10-->
    <div class="card card-custom card-stretchs gutter-b">
        <!--begin::Header-->
        <div class="card-header border-0">
            <h3 class="card-title font-weight-bolder text-dark"><span class="label label-lg label-danger mr-2">2</span>{{ trans('Api::api.location.districts.header') }}</h3>
            <div class="card-toolbar">
                <div class="accordion accordion-light accordion-light-borderless accordion-toggle-plus" id="accordion_districts">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title collapse text-hover-primary" data-toggle="collapse" data-target="#collapse_districts" aria-expanded="false">
        ...
        <div class="card-bodys pt-5">
            <div class="col-lg-12 collapse show" id="collapse_districts" data-parent="#accordion_districts">
                <div class="p-4">
                    ...
                    <div class="card card-custom card-stretchs gutter-b mt-8 bg-light-cus rounded">
                        ...
                        <div class="card-header border-0">
                            ...
                            <div class="card-toolbar">
                                <button type="button"  class="btn btn-primary font-weight-bold btn-sm px-3 font-size-base btn-districts"> {{ trans('Api::api.common.submit') }}</button>
                            </div>
                        </div>
                        <!--end::Header-->
                        <!--begin::Body-->
                                    ...
                                    <div class="row bg-light-white rounded">
                                        <div class="col-lg-12 mt-6">
                                            <div class="form-group">
                                                <select class="form-control custom-select select2 seState" name="state_id">
                                                </select>
                                            </div>
                    ...
                    <div class="bg-light-cus rounded p-4 mt-8 mb-5">
                        ...
                        <div class="d-flex align-items-center justify-content-between font-size-h6">
                            <div class="col-lg-12 json_response_districts bg-light-white rounded">
