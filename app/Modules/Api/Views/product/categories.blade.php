<div class="col-lg-12" id="box_categories">
    <!--begin::List Widget 10-->
    <div class="card card-custom card-stretchs gutter-b">
        <!--begin::Header-->
        <div class="card-header border-0">
            <h3 class="card-title font-weight-bolder text-danger"><span class="label label-lg label-danger mr-2">3</span>{{ trans('Api::api.product.categories.header') }}</h3>
            <div class="card-toolbar">
                <div class="accordion accordion-light accordion-light-borderless accordion-toggle-plus" id="accordion_categories">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title collapse text-hover-dark text-danger" data-toggle="collapse" data-target="#collapse_categories" aria-expanded="false">
        ...
        <div class="card-bodys pt-5">
            <div class="col-lg-12 collapse show" id="collapse_categories" data-parent="#accordion_categories">
                <div class="p-4">
                    ...
                    <div class="card card-custom card-stretchs gutter-b mt-8 bg-light-cus rounded">
                        ...
                        <div class="card-header border-0">
                            ...
                            <div class="card-toolbar">
                                <button type="button"  class="btn btn-primary font-weight-bold btn-sm px-3 font-size-base btn-filter-categories"> {{ trans('Api::api.common.submit') }}</button>
                            </div>
                        </div>
                        <!--end::Header-->
                        <!--begin::Body-->
                                                                ...
                                                                <li role="treeitem" aria-selected="false" aria-level="1" aria-labelledby="j1_1_anchor" aria-expanded="false" id="j1_1" class="jstree-node jstree-closed">
                                                                    <a class="jstree-anchor">
                                                                        <label class="radio-radio-rounded">
                                                                            ...
                                                                            <span></span> <label class="category_name_0">{{ trans('Product::category.add.form.parent_id') }}</label>
                                                                        </label>
                                                                    </a>
                                                                </li>
                    ...
                    <div class="bg-light-cus rounded p-4 mb-5">
                        ...
                        <div class="d-flex align-items-center justify-content-between font-size-h6">
                            <div class="col-lg-12 response-categories bg-light-white rounded">
