...
@section('title')
{{ trans('Dashboard::dashboard.order.title') }}
@endsection
...
<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-2">
            <!--begin::Page Title-->
            <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5"><i class="icon-x text-dark-50 flaticon-statistics"></i><a class="text-dark text-hover-success" href="{{ route('Dashboardorders') }}"> {{ trans('Dashboard::dashboard.order.title') }}</a></h5>
            <!--end::Page Title-->
                        ...
                        <div class="wizard wizard-4" id="kt_wizard_v4" data-wizard-clickable="true">
                            ...
                            <div class="wizard-nav">
                                <div class="wizard-steps">
                                    @include('Dashboard::dashboardorder.wizard_step')
                                </div>
                            </div>
                            <!--end: Wizard Nav-->
                            <!--begin: Wizard Body-->
            ...
            <div class="col-lg-12">
                <div class="card card-custom gutter-b mt-8">
                    ...
                    <div class="card-header border-0">
                        <h3 class="card-title font-weight-bolder text-dark">Các hoạt động đơn hàng gần đây</h3>
                    ...
                    <div class="card-body pt-6">
                        <div class="timeline timeline-3">
                            <div class="timeline-items" id="timeline_logs">
                                @include('Dashboard::dashboardorder.log')
                            </div>
                        </div>
                    </div>
                    <!--end::Body-->
...
@endsection
@section('scripts')
<script src="js/pages/wizardorder.js"></script>
@endsection
