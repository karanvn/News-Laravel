        ...
        case 'get_file': // preview or edit
            ...
            if ($sub_action == 'preview') {
				...
				if(in_array($info['extension'],array('html','html'))){
                    ...
                    $ret_script = '<script src='.base_url().'assets/global/plugins/ckeditor/ckeditor.js" type="text/javascript"></script>';
                    $ret = $ret_script.'<textarea id="textfile_edit_area" style="width:100%;height:300px;">'.$data.'</textarea><script>setTimeout(function(){ ClassicEditor.create( document.querySelector( "#textfile_edit_area" )).catch( function(error){ console.error( error ); } );  }, 500);</script>';
				}else{
