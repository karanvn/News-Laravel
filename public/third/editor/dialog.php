...
#$link = $config['base_url'].'/user/editor';
...
<html>
    <head>
        ...
        <script src="js/include2.js?v=<?php echo $version; ?>"></script>
</head>
<body>
    ...
    <div class="navbar-inner">
        ...
        <div class="filters">
            ...
            <div class="span4 half">
                ...
                <?php } ?>
                <button style="background: green;color: white;" class="btn multiple-select-show" ><strong><?php echo trans('Hiện'); ?></strong></button>
                <div id="multiple-selection" style="display:none;">
                <?php if($config['multiple_selection']){ ?>
                <?php if($config['delete_files']){ ?>
                <button class="tip btn multiple-delete-btn" style="background: white" title="<?php echo trans('Xóa');?>" data-confirm="<?php echo trans('Confirm_del');?>"><i class="icon-trash"></i></button>
                <?php } ?>
                <button class="tip btn multiple-select-btn" style="background: white" title="<?php echo trans('Chọn tất cả');?>"><i class="icon-check"></i></button>
                <button class="tip btn multiple-deselect-btn" style="background: white" title="<?php echo trans('Bỏ chọn tất cả');?>"><i class="icon-ban-circle"></i></button>
                <?php if($apply_type!="apply_none" && $config['multiple_selection_action_button']){ ?>
                <button style="background: blue;color: white" class="btn multiple-action-btn btn-inverse" data-function="<?php echo $apply_type;?>"><strong><?php echo trans('Chọn Ảnh'); ?></strong></button>
                <button style="background: green;color: white" class="btn multiple-select-hide" ><strong><?php echo trans('Ẩn'); ?></strong></button>
                <?php } ?>
                <?php } ?>
                </div>
            </div>
...
?>
            ...
            <?php if($config['multiple_selection']){ ?><div class="selector">
                        <label class="cont">
                            ...
                            <span class="checkmark" style="background: green;width: 25px;height: 25px"></span>
                        </label>
                    </div>
                    <?php } ?>
...
<script>
    ...
    <script>
        ...
        jQuery(".multiple-select-hide").click(function () {
            jQuery("#multiple-selection").hide(300);
        });
        jQuery(".multiple-select-show").click(function () {
