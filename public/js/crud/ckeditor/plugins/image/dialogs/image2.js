...
(function () {
    var r = function (c, j) {
        ...
        return {
            ...
            onOk: function () {
                var src_img = this.preview.getAttribute('src');
                var src_imgs = src_img.split(',');
                for(i = 0; i < src_imgs.length; i = i + 1){
                    var img_path = src_imgs[i];
                    ...
                    this.imageElement.setAttributes({
                        'data-cke-saved-src': img_path
                    });
                    this.imageElement.setAttribute("src", img_path);
                    ...
                    c.insertElement(c.document.createElement("br"));
                }
            },
            onLoad: function () {
                ...
                id: "info", label: c.lang.image.infoTab, accessKey: "I", elements: [{
                    ...
                    type: "hbox", children: [{
                        ...
                        type: "vbox", height: "250px", children: [{
                            ...
                            '<br><div id="' + m + '" class="ImagePreviewLoader" style="display:none"><div class="loading">&nbsp;</div></div><div class="ImagePreviewBox"><table><tr><td><a href="javascript:void(0)" target="_blank" onclick="return false;" class="' + A + '"><img id="' + z + '" alt="" /></a>' + (c.config.image_previewText || "") +
                            "</td></tr></table></div></div>"
                        }]
                    }]
                }]
